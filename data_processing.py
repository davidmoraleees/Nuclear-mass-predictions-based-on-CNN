...
def main(data_folder, plots_folder, processed_folder):
    ...
    plot_data(df2016, "Diff_nuclear_mass", r"$\Delta$ (MeV)", "nuclear_mass_expteo_dif.pdf", plots_folder,
              cmap="seismic", vmin=-14, vcenter=0, vmax=14, title_name="LDM")
    plot_data(df2016, "WS4_diff", r"$\Delta$ (MeV)", "nuclear_mass_expws4_dif.pdf", plots_folder,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--processed_folder", default="data_processed")
    args = parser.parse_args()

    main(args.data_folder, args.plots_folder, args.processed_folder)
